...
<head>
  ...
  <!-- Favicons -->
  <link href="{{ URL::asset('admin/backend/assets/img/favicon.png')}}" rel="icon">
  <link href="{{ URL::asset('admin/backend/assets/img/apple-touch-icon.png')}}" rel="apple-touch-icon">
          ...
          <div class="row log-h">
            <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 bg-log d-flex align-items-center">
              <div class="log-in-logo d-flex justify-content-center">
                <img class="w-50" src="{{ URL::asset('admin/backend/assets/img/dhaam-logo.png')}}">
              </div>
            </div>
