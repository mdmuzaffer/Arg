...
<body style="background-image: url('admin/assets/images/background/loginbg.jpg'); background-repeat:no-repeat; background-size:cover;">
            ...
            <div class="auth-box border-top border-secondary">
                <div id="loginform">
                    <div class="text-center pt-3 pb-3">
                        <span class="db"><img src="{{ URL::asset('admin/assets/images/logo.png')}}" alt="logo" /></span>
                    </div>
                    <!-- Form -->
                        ...
                        <div class="row pb-4">
                            <div class="col-12">
                                <div class="input-group mb-3">
                                    ...
                                    <input id="email" type="email" class="form-control @error('email') is-invalid @enderror" placeholder="Username" aria-label="Username" aria-describedby="basic-addon1" name="email" value="{{ old('email') }}" required autocomplete="email" autofocus>
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <input placeholder="Password" aria-label="Password" aria-describedby="basic-addon1" id="password" type="password" class="form-control form-control-lg @error('password') is-invalid @enderror" name="password" required autocomplete="current-password">
                ...
                <div id="recoverform">
                    <div class="text-center">
                        <span class="text-white">Enter your e-mail address below and we will send you instructions how to recover a password 2222.</span>
                    </div>
                    <div class="row mt-3">
                        <!-- Form -->
