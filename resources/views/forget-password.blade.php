              ...
              <div class="log-in-fields shadow  rounded w-50 relative mx-auto">
                <div class="leaf-img">
                  ...
                  <div class="log-in-heading">
                    <h4 class="fw-bold log">Forget your password</h4>
                  </div>
                  @if(session('message'))
                  ...
                  <div class="form-fields">
                    ...
                    <form method="POST" class="was-validated" action="{{ route('forget.password') }}">
                     @csrf

                      <div class="mb-3 mt-3">
                        <label for="uname" class="form-label">Email</label>

                        <input id="uname" type="text" class="form-control @error('email') is-invalid @enderror" placeholder="Enter your email" name="email" value="{{ old('email') }}" required  >
                  ...
                  <div class="get-help d-flex justify-content-center">
                    <p class="get-help-sign"><a href="/">Get help signed in</a></p>
                  </div>
              </div>
            </div>
          </div>
