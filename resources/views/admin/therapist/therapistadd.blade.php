            ...
            <div class="card-body">
              ...
              <!-- Table with stripped rows -->
                  <div class="card-body">
                      ...
                      <form method="post" action="{{route('addTherapist')}}">
                        @csrf
                        <div class="row">
                         <div class="col-xl-5 col-lg-5 col-md-12">
                             <div class="row">
                                 ...
                                 <div class="col-xl-7 col-lg-7 col-md-6 col-sm-12 mb-3">
                                  <input type="text" class="form-control" id="name" name="firstname" value="{{ old('firstname') }}" placeholder="First name">
                                @error('firstname')
                            ...
                            <div class="row">
                              ...
                              <div class="col-xl-7 col-lg-7 col-md-6 col-sm-12">
                               <input type="text" class="form-control" id="mobile" name="mobile_no" value="{{ old('mobile_no') }}" placeholder="Mobile">
