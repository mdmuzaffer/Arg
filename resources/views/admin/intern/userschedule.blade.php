    ...
    <section class="section profile">
       ...
       <div class="row">
        <div class="col-xl-12">
            ...
            <form action="{{route('userTreatmentpdfUploadfile')}}"  method="POST" enctype="multipart/form-data">
              @csrf

              <div class=" col-xl-8 col-lg-8 col-md-12 col-sm-12 img-down">
                <div class="mb-5">
                  <input class="form-control push-img text-white" type="file" name="files[]" multiple>
                </div>
              </div>
