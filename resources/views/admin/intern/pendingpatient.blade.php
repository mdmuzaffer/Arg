        ...
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-body">
              ...
              <table cellspacing="0" cellpadding="0" class="table datatable">
                <thead>
                  ...
                  <tr>
                   ...
                   <!--  <td>
                    ...
                    <td>
                      ...
                      <span class="badge text-bg-info bg-info text-white py-2"><a class="text-white" href="{{route('intern.userProfile',$patient['id'])}}" >View</a></span>
                      ...
                      <span class="badge text-bg-secondary btn-secondary text-white py-2" data-userid="{{$patient['id']}}" data-bs-toggle="modal" data-bs-target="#verticalycentered_{{$patient['id']}}">Section status</span>
