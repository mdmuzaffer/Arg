                  ...
                  <tr>
                   ...
                   <!--  <td>
                    ...
                    <td>
                      ...
                      <button type="button" class="btn btn-warning rounded-pill"><a class="text-white" href="{{route('doctor.userSchedule',$patient['id'])}}" >schedule</a></button>
                      ...
                      <span type="button" class="btn btn-outline-primary btn-sm p-1" style=width:95px;> <img src="/images/icone/Schedule.png" style=width:18px;><a class="ms-1" href="{{route('doctor.userSchedule',$patient['id'])}}" >schedule</a></span>
